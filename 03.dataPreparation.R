# We needed this script in the earlier version of the manuscript when we fitted SDMs in species-season-realm
# combinations. This time, we are calculating country-wise situation instead of realm-wise.
